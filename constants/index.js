export const navLinks = [
  ...
  { label: 'الذكاء الاصطناعي', path: '/ai-image-generator' }
];
...
export const footerLinks = [
  ...
  {
    title: 'مُولِّد الصور بواسطة الذكاء الاصطناعي',
    links: [
      { title: 'البحث عن الصور ', url: '/ai-image-generator' },
      { title: 'إنشاء صور ', url: '/ai-image-generator/create-post' },
    ],
  },
  {
    title: 'سجّل الآن',
