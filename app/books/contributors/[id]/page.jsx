...
export async function generateMetadata(paramKey){
 ...
 const genericAuthorDescription = "استمتع بقراءة كتب هذا المؤلف واكتشف عالمه الأدبي. تعرّف على رؤية الكاتب وأسلوبه من خلال أعماله المميزة. استكشف المزيد حول المؤلف في أمة اقرأ: ";  
 return {
   title: `${name} - أمة اقرأ`,
